...
This directory contains source files for the Balkan Romani language
...
-   <https://giellalt.uit.no/lang/rmn/index.html> (analyser)
...
The Balkan Romani language sources can be acquired using [giella SVN
